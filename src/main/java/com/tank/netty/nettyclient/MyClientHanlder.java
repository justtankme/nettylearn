 ...
 *监听channel状态的变化
 */
public class MyClientHanlder extends ChannelInboundHandlerAdapter {
	private ChannelGroup channelGroup;
	
	public MyClientHanlder() {
		
	}
	
	public MyClientHanlder(ChannelGroup channelGroup) {
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		System.out.println(ctx.channel().localAddress().toString() + " 欢迎上线");
	}
	...
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		System.out.println(ctx.channel().localAddress().toString() + " 欢迎再次光临");
	}
